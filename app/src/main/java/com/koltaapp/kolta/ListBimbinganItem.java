...
public class ListBimbinganItem {
    ...
    public ListBimbinganItem(String username, String nama_tugas, String nama_file, String url_document, String deskripsi, String tanggal_pengumpulan, String tanggal_pertemuan) {
