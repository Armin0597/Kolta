...
public class TaskMainAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                listStudentTaskAdapter = new ListStudentTaskAdapter(TaskMainAct.this, list);
                list_student.setAdapter(listStudentTaskAdapter);
            }
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent gotohome = new Intent(TaskMainAct.this, HomePageTeacherActivity.class);
