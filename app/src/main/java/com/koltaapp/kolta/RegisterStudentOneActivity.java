    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       btn_continue.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View v) {
               ...
               if(username.getText().toString().isEmpty()){
                   ...
                   reference_username = FirebaseDatabase.getInstance().getReference()
                           .child("Mahasiswa").child(username.getText().toString());
                               ...
                               reference.addListenerForSingleValueEvent(new ValueEventListener() {
                                   ...
                                   public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                       if(dataSnapshot.exists()){
                                           ...
                                           //berpindah activity
                                           Intent gotoregistertwo = new Intent(RegisterStudentOneActivity.this, RegisterStudentTwoActivity.class);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent backtochooserole = new Intent(RegisterStudentOneActivity.this, ChooseRoleActivity.class);
                startActivity(backtochooserole);
            }
        });
