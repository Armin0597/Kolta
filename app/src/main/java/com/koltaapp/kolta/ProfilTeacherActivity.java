...
public class ProfilTeacherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Picasso.with(ProfilTeacherActivity.this).load(dataSnapshot.child("url_photo_profile").getValue().toString())
        ...
        btn_editprofil.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent gotoeditteacherpage = new Intent(ProfilTeacherActivity.this, ProfileEditTeacherActivity.class);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gotohometeacherpage = new Intent(ProfilTeacherActivity.this, HomePageTeacherActivity.class);
        ...
        btn_signout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //berpindah activity
                Intent gotosignin = new Intent(ProfilTeacherActivity.this, SignInTeacherActivity.class);
