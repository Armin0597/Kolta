...
public class ListKehadiranItem {
    String nama,nim,url_photo_profile,prodi,email_address,username;

    public ListKehadiranItem() {
    }

    public ListKehadiranItem(String nama, String nim, String url_photo_profile, String prodi, String email_address, String username) {
        this.nama = nama;
        this.nim = nim;
