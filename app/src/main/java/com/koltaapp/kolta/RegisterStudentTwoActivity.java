...
public class RegisterStudentTwoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_continue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(nama.getText().toString().isEmpty()){
                    ...
                    Toast.makeText(getApplicationContext(), "Prodi Tidak Boleh Kosong", Toast.LENGTH_SHORT).show();
                    ...
                    if(photo_location != null){
                        ...
                        storageReference.putFile(photo_location)
                            ...
                            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                                ...
                                //berpindah activity
                                Intent gotousersignup = new Intent(RegisterStudentTwoActivity.this, UserSignupActivity.class);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gotoregisterone = new Intent(RegisterStudentTwoActivity.this, RegisterStudentOneActivity.class);
