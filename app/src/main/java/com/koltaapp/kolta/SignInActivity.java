    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_signin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mhsreference = FirebaseDatabase.getInstance().getReference()
                        .child("Mahasiswa").child(username);
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            if (password.equals(passwordFromFirebase)) {
                                ...
                                //berpindah activity
                                Intent gotohome = new Intent(SignInActivity.this, HomePageActivity.class);
                ...
                btn_create_new_acc.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent gotochooserole = new Intent(SignInActivity.this, RegisterStudentOneActivity.class);
