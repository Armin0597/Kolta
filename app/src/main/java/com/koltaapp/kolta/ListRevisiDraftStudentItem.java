...
public class ListRevisiDraftStudentItem {
    String mhs_id,nama_file,url_document;

    public ListRevisiDraftStudentItem() {
    }

    public ListRevisiDraftStudentItem(String mhs_id, String nama_file, String url_document) {
        this.mhs_id = mhs_id;
